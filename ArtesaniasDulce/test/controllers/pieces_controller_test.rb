...
class PiecesControllerTest < ActionController::TestCase
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post :create, piece: { category_id: @piece.category_id, matter_name: @piece.matter_name, piece_name: @piece.piece_name, piece_quantity: @piece.piece_quantity, price: @piece.price }
    end
  ...
  test "should update piece" do
    patch :update, id: @piece, piece: { category_id: @piece.category_id, matter_name: @piece.matter_name, piece_name: @piece.piece_name, piece_quantity: @piece.piece_quantity, price: @piece.price }
    assert_redirected_to piece_path(assigns(:piece))
  end
