class CategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @category.save
        format.html { redirect_to home_index_path, notice: 'Category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @category.update(category_params)
        format.html { redirect_to home_index_path, notice: 'Category was successfully updated.' }
  ...
  def destroy
    @category = Category.find(params[:categories_ids])
    @category.destroy()
    respond_to do |format|
